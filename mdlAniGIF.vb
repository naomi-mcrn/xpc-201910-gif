...
Module AniGIF
    ...
    Public Sub SaveAnimatedGif(ByVal fileName As String,
                                  ByVal baseImages As Bitmap(),
                                  ByVal delayTime As UInt16,
    ...
    Private Function ReadBytes(ByVal ms As MemoryStream,
    ...
    Private Function GetApplicationExtension(ByVal loopCount As UInt16) _
            As Byte()
    ...
    Private Function GetGraphicControlExtension(ByVal delayTime As UInt16) _
        As Byte()
